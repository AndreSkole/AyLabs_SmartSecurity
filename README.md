...
3. Install the required Python packages: The project relies on OpenCV, and it's crucial to install the contrib package which includes the face recognition module.
...
How to Use
Start the System: Run python app.py in your terminal.
Access the Web Interface: Open your web browser and navigate to http://127.0.0.1:5000.
Live Monitoring: The "Live Kamera" tab shows the real-time feed from your webcam. Any faces detected will be framed. Initially, all faces will be marked as "Unknown". The system will automatically save a snapshot of each unique unknown face to the database/ directory.
Register New Faces:
...
View Recognized Faces: Return to the "Live Kamera" tab. The system will now recognize and label the people you have trained it on.
Review History:
